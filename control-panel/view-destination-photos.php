...
<html> 
    <head>
        ...
        <title>Destionation-photo</title>
        <!-- Favicon-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    <?php
                                    $DESTINATION_PHOTO = DestinationPhoto::getAttractionPhotosById($id);
                                        ...
                                        foreach ($DESTINATION_PHOTO as $key => $destination_photo) {
                                            ...
                                            <div class="col-md-3" id="div<?php echo $destination_photo['id']; ?>">
                                                <div class="photo-img-container">
                                                    <img src="../upload/attraction/gallery/thumb/<?php echo $destination_photo['image_name']; ?>$destination_photo" class="img-responsive ">
                                                </div>
